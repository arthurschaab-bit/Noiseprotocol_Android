...
class SettingsManager(
    ...
    /**
     * Ob der Stammdaten-Dialog (Messgeraet, Messaufbau, Randbedingungen fuer den Gesamtbericht)
     * bei jedem Messbeginn erscheint - Owner-Anfrage 10.09.2026: diese Angaben sollen nicht mehr
     * als fixer Wert in den Einstellungen stehen, sondern je Messung erfasst werden (die zuletzt
     * verwendeten Werte aus [com.example.lrmprotokoll.data.StammdatenVerlaufDao] dienen dabei als
     * Vorschlag). Default AN, analog [fotoDokuAktiv] - abschaltbar fuer Nutzer, die den
     * Gesamtbericht gar nicht verwenden.
     */
