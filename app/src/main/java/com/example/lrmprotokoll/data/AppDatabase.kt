...
/**
 * Nachtraegliche Stammdaten fuer einen historischen Messtag (Owner-Entscheidung 14.09.2026):
 * [StammdatenVerlaufEntity.erstelltAm] bleibt der echte Erfassungszeitpunkt. Die neue nullable
 * Spalte ordnet nur den Geltungstag zu; alle alten Zeilen bleiben durch NULL unveraendert.
 */
val MIGRATION_24_25 = object : Migration(24, 25) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE `stammdaten_verlauf` ADD COLUMN `giltFuerTagStart` INTEGER")
    }
}
