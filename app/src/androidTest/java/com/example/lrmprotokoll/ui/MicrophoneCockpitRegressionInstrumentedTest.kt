...
/**
 * Echtes Geraete-Pendant zu [MicrophoneCockpitRegressionTest] (Robolectric, app/src/test) - Teil
 * der Bestandsaufnahme nach dem Datumsbereich-Dialog-Bug (Owner-Auftrag 15.09.2026). Oeffnet ueber
 * die echten Service-Flows das echte [MarkNoiseEventBottomSheet] und prueft die Speicherkette bis
 * in die Datenbank auf echtem Geraet.
 */
@RunWith(AndroidJUnit4::class)
class MicrophoneCockpitRegressionInstrumentedTest {
    ...
    @Test fun meterSessionOhneVerbindungZeigtMikrofonwertAlsErkennbarenFallback() {
        ...
        val fallbackUnit = composeRule.activity.getString(R.string.cockpit_meter_fallback_unit)
        composeRule.onNodeWithText("48.2").assertExists()
