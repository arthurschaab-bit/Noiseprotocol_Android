...
Generiert am: Wed Sep 16 08:20:14 UTC 2026

## Tests
- JVM-/Robolectric-Tests: **934** (aus 168 XML-Berichten unter `build/test-results/testDebugUnitTest`) · 0 Failures, 0 Errors
- Instrumentierte Tests (Emulator): **167** `@Test`-Annotationen in 53 Dateien unter `src/androidTest`
...
## Datenbank
- Room-Schemaversion: **25** (`AppDatabase.kt`)
