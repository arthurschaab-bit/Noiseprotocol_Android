...
Generiert am: Wed Sep 16 03:52:35 UTC 2026

## Tests
- JVM-/Robolectric-Tests: **937** (aus 169 XML-Berichten unter `build/test-results/testDebugUnitTest`) · 0 Failures, 0 Errors
- Instrumentierte Tests (Emulator): **149** `@Test`-Annotationen in 46 Dateien unter `src/androidTest`
