...
Generiert am: Fri Sep 11 19:11:00 UTC 2026

## Tests
- JVM-/Robolectric-Tests: **888** (aus 156 XML-Berichten unter `build/test-results/testDebugUnitTest`) · 0 Failures, 0 Errors
- Instrumentierte Tests (Emulator): **80** `@Test`-Annotationen in 25 Dateien unter `src/androidTest`
...
## Datenbank
- Room-Schemaversion: **20** (`AppDatabase.kt`)
